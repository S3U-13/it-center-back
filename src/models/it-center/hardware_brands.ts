...
class HardwareBrands extends Model<
  InferAttributes<HardwareBrands>,
  InferCreationAttributes<HardwareBrands>
> {
  declare hardware_id: CreationOptional<number>;
  declare brand: CreationOptional<number | null>;
  declare model: CreationOptional<number | null>;
