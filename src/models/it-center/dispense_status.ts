...
class DispenseStatus extends Model<InferAttributes<DispenseStatus>, InferCreationAttributes<DispenseStatus>> {
...
DispenseStatus.init(
  ...
  },
  {
    ...
    tableName: "dispense_status",
    timestamps: true,
  },
);

export default DispenseStatus;
